...
public class TimeModule extends Module implements Renderable {
    ...
    public final BooleanSetting showSeconds = new BooleanSetting(this, false, "Show Seconds");
    ...
    public TimeModule(Category category, Description description, String name) {
    ...
    private void drawText() {
        ...
        if (invert.isEnabled()) {
            if (backgroundEnabled.isEnabled()) text = String.format("Time: %s", value);
            else text = String.format("[Time: %s]", value);
            title = "Time ";
        } else {
