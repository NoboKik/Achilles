...
public class PotionsHUDModule extends Module implements Renderable {
    ...
    public final BooleanSetting outlineWave = new BooleanSetting(this, false, "Outline's Wave");
    public final BooleanSetting outlineFill = new BooleanSetting(this, false, "Outline's Fill");
    ...
    public PotionsHUDModule(Category category, Description description, String name) {
    ...
    public void render() {
        ...
        if (mc.player != null && mc.world != null) {
            ...
            for (StatusEffectInstance effect : effects) {
                ...
                String keyText = StatusEffectUtil.getDurationText(effect, 1, mc.world.getTickManager().getTickRate()).getString();
                float w = ImGui.getWindowSize().x;
        ...
        if (glowEnabled.isEnabled()) {
            ...
            if (waveGlow.isEnabled()) {
                ...
                //);
                GuiUtils.drawWaveWindowShadow(waveSpeed.getFValue(), waveGlowIndex.getFValue(), glowSize.getFValue(), glowFill.isEnabled(), alpha, 0);
            } else {
