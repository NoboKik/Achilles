...
public class TotemCountModule extends Module implements Renderable {
    ...
    public TotemCountModule(Category category, Description description, String name) {
    ...
    private void drawText() {
        String text;
        String title;
        String value = getTotems()+"";
        if (invert.isEnabled()) {
            if (backgroundEnabled.isEnabled()) text = String.format("Totems: %s", value);
            else text = String.format("[Totems: %s]", value);
            title = "Totems ";
        } else {
            if (backgroundEnabled.isEnabled()) text = String.format("%s totems", value);
            else text = String.format("[%s totems]", value);
            title = " totems";
        }
