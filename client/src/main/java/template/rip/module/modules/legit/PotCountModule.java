...
public class PotCountModule extends Module implements Renderable {
    ...
    public PotCountModule(Category category, Description description, String name) {
    ...
    private long getPots() {
        return ItemHelper.getTotal(new ItemStack(Items.SPLASH_POTION));
    }

    private void drawText() {
        String text;
        String title;
        String value = getPots()+"";
        if (invert.isEnabled()) {
            if (backgroundEnabled.isEnabled()) text = String.format("Pots: %s", value);
            else text = String.format("[Pots: %s]", value);
            title = "Pots ";
        } else {
            if (backgroundEnabled.isEnabled()) text = String.format("%s pots", value);
            else text = String.format("[%s pots]", value);
            title = " pots";
        }
    ...
    public void render() {
        ...
        ImGui.begin(this.getName()+"/Legit", imGuiWindowFlags);
