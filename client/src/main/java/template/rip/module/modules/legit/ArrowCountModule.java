...
public class ArrowCountModule extends Module implements Renderable {
    ...
    public ArrowCountModule(Category category, Description description, String name) {
    ...
    private long getArrows() {
        return ItemHelper.getTotal(new ItemStack(Items.ARROW)) + ItemHelper.getTotal(new ItemStack(Items.SPECTRAL_ARROW)) + ItemHelper.getTotal(new ItemStack(Items.TIPPED_ARROW));
    }

    private void drawText() {
        String text;
        String title;
        String value = getArrows() + "";
        if (invert.isEnabled()) {
            if (backgroundEnabled.isEnabled()) text = String.format("Arrows: %s", value);
            else text = String.format("[Arrows: %s]", value);
            title = "Arrows ";
        } else {
            if (backgroundEnabled.isEnabled()) text = String.format("%s arrows", value);
            else text = String.format("[%s arrows]", value);
            title = " arrows";
        }
