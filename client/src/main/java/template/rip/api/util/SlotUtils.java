...
public class SlotUtils {
    ...
    public static int indexToId(int i) {
        ...
        if (handler instanceof GenericContainerScreenHandler) return genericContainer(i, ((GenericContainerScreenHandler) handler).getRows());
    ...
    private static int horse(ScreenHandler handler, int i) {
        if (handler instanceof HorseScreenHandler screenHandler) {
            AbstractHorseEntity entity = screenHandler.entity;
            ...
            if (entity instanceof LlamaEntity llama) {
                ...
                if (isHotbar(i)) return 29 + i;
                if (isMain(i)) return 2 + (i - 9);
            } else if (entity instanceof AbstractDonkeyEntity donkey) {
                boolean chest = donkey.hasChest();
