...
public class LegitModules implements Renderable {

    private static LegitModules instance;
    public static Module editingModule = null;
    public float scrollY = 0;
    public float scrollUntil = 0;

    public static LegitModules getInstance() {
        if (instance == null) {
            instance = new LegitModules();
        }
        return instance;
    }
    ...
    public void render() {
        ...
        float posX = LegitMenu.getInstance().getPos().x;
        float posY = LegitMenu.getInstance().getPos().y+80;
        ...
        for (Module module : all) {
            ...
            boolean isToggled = ImGui.button("##", 182f, 150f);
            ...
            ImGui.setCursorPos(prevPos.x + 160f, prevPos.y + 20f);
            ImGui.text("\uF142");
            ImGui.setCursorPos(postPos.x, postPos.y);
            ImGui.popFont();
            ImGui.popStyleColor(1);
        ...
        if (editingModule != null) {
            ...
            imGuiWindowFlags |= ImGuiWindowFlags.NoResize;
            imGuiWindowFlags |= ImGuiWindowFlags.NoCollapse;
            posX = LegitMenu.getInstance().getPos().x;
            posY = LegitMenu.getInstance().getPos().y;
            ...
            if (editingModule != null) {
                ...
                ImGui.getStyle().setWindowBorderSize(1f);
                ImGui.getStyle().setFrameBorderSize(0f);
                posX = LegitMenu.getInstance().getPos().x + 800 - 206;
                posY = LegitMenu.getInstance().getPos().y;
                ImGui.setNextWindowPos(posX, posY);
